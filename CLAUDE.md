...
./gradlew testDebugUnitTest --tests "com.bugzapperlabs.mycasts.playback.PlaybackControllerTest"  # single test class
...
`com.bugzapperlabs.mycasts.debug` (vs. the release build's `com.bugzapperlabs.mycasts`) so a debug
